...
for town in graph:
    ...
    for each_town in costs:
        if each_town not in dict_min_value_each_town:
            dict_min_value_each_town[each_town] = float('inf')
        if dict_min_value_each_town[each_town]>costs[each_town] and costs[each_town] !=0:
            dict_min_value_each_town[each_town]=costs[each_town]
    print(costs)
    print(sum(costs.values()))

print(dict_min_value_each_town)
